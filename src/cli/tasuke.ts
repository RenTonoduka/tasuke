...
const COMMANDS: CmdDef[] = [
  ...
  { name: 'task:request',   desc: 'タスクを担当者に依頼(受諾待ち)', usage: '--taskId ID --assigneeId ID [--dueDate ISO] [--comment TEXT]', example: 'tasuke task:request --taskId abc --assigneeId user1' },
  { name: 'task:accept',    desc: '依頼を受諾', usage: '--taskId ID', example: 'tasuke task:accept --taskId abc' },
  { name: 'task:decline',   desc: '依頼を辞退(コメント必須)', usage: '--taskId ID --comment TEXT', example: 'tasuke task:decline --taskId abc --comment "今は無理"' },
  { name: 'task:submit',    desc: '完了報告(承認待ちへ)', usage: '--taskId ID', example: 'tasuke task:submit --taskId abc' },
...
const CLI_TO_MCP: Record<string, string> = {
  ...
  'task:accept': 'task_accept',
  'task:decline': 'task_decline',
